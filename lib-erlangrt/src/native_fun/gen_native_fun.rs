...
pub static BIF_TABLE: &'static [BifTabItem] = &[
    ...
    BifTabItem { m: gen_atoms::ERLANG, f: gen_atoms::TL, arity: 1,
        func: native_fun::ubif_erlang_tl_1 },
];
