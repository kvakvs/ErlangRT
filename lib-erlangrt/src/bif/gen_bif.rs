...
pub static BIF_TABLE: &'static [BifTabItem] = &[
  ...
  BifTabItem {
    m: gen_atoms::ERLANG,
    f: gen_atoms::INTEGER_TO_LIST,
    arity: 1,
    func: bif::bif_erlang_integer_to_list_1,
  },
  BifTabItem {
    m: gen_atoms::ERLANG,
    f: gen_atoms::IS_BOOLEAN,
    arity: 1,
    func: bif::ubif_erlang_is_boolean_1,
  },
  BifTabItem {
    m: gen_atoms::ERLANG,
    f: gen_atoms::IS_PROCESS_ALIVE,
    arity: 1,
