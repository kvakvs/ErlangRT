...
pub const LISTS: LTerm = LTerm::make_atom(21);
pub const LOW: LTerm = LTerm::make_atom(22);
pub const MEMBER: LTerm = LTerm::make_atom(23);
...
pub const SPAWN_SYSTEM_PROCESS: LTerm = LTerm::make_atom(28);
