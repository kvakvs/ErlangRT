...
pub const _JUMP_TABLE: Term = Term::make_atom(0);
pub const SYM_PLUS: Term = Term::make_atom(1);
pub const SYM_MINUS: Term = Term::make_atom(2);
pub const SYM_EQ_EQ: Term = Term::make_atom(3);
