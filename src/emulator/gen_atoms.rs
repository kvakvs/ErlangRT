...
pub const NOCATCH: LTerm = LTerm { value: make_atom_raw_const(23) };
pub const NORMAL: LTerm = LTerm { value: make_atom_raw_const(24) };
pub const OK: LTerm = LTerm { value: make_atom_raw_const(25) };
pub const SELF: LTerm = LTerm { value: make_atom_raw_const(26) };
pub const SYSTEM_LIMIT: LTerm = LTerm { value: make_atom_raw_const(27) };
pub const THROW: LTerm = LTerm { value: make_atom_raw_const(28) };
pub const TRAP_EXIT: LTerm = LTerm { value: make_atom_raw_const(29) };
pub const TRUE: LTerm = LTerm { value: make_atom_raw_const(30) };
pub const UNDEF: LTerm = LTerm { value: make_atom_raw_const(31) };
pub const UNDEFINED: LTerm = LTerm { value: make_atom_raw_const(32) };
